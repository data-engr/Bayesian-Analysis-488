...
2. Hierarchical Normal Priors: $\beta_j | \tau \sim \text{Normal}(0,\tau) $, where $\tau^2 \sim \text{InerseGamma}(0.01, 0.01)$.

3. Bayesian LASSO: $\beta_j | \tau \sim \text{DE}(0,\tau)$, where $\tau^2 \sim \text{InverseGamma}(0.01,0.01)$. #Double exponential
