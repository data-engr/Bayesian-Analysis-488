...
Under the binomial distribution, with a probability of defect equal to 0.09 and 100 samples taken, I could expect to see 9 defects. With a standard deviation of approximately 3, then the number of defects I saw on day 1 would be equivalent to a 1 standard deviation move. 


On day 5 I would have to claim the machine is out of order, because I should expect to see 45 cumulative defects with one standard deviation being 15, assuming the binomial distribution and a theta of 0.9. With 65 cumulative defects the machine has passed the expected number of defects by a number greater than 1 standard deviation. 
